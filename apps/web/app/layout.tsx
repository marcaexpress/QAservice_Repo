...
export default function RootLayout({
  ...
  return (
    <html lang="es">
      <head>
        {/* 🚨 CSS CRÍTICO INLINE - GARANTIZA ESTILOS */}
        <style dangerouslySetInnerHTML={{
          __html: `
            ...
            * { box-sizing: border-box !important; }
            ...
            .focus\\:ring-offset-2:focus { box-shadow: 0 0 0 2px rgba(59, 130, 246, 0.5), 0 0 0 4px white !important; }

            /* === VARIANTES DE BOTÓN === */
            .bg-primary-600 { background-color: #2563eb !important; }
            .hover\\:bg-primary-700:hover { background-color: #1d4ed8 !important; }
            .focus\\:ring-primary-500:focus { box-shadow: 0 0 0 2px rgba(37, 99, 235, 0.5) !important; }
            .bg-gray-200 { background-color: #e5e7eb !important; }
            .hover\\:bg-gray-300:hover { background-color: #d1d5db !important; }
            .focus\\:ring-gray-500:focus { box-shadow: 0 0 0 2px rgba(107, 114, 128, 0.5) !important; }
            ...
            /* === FORCE FLAGS === */
            /* 🚨 ESTO GARANTIZA QUE LOS ESTILOS APAREZCAN SÍ O SÍ */
            * { box-sizing: border-box !important; }
            body { 
              font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', sans-serif !important;
              line-height: 1.6 !important;
